...
## [0.5.0](https://github.com/tbhb/obsidian-vite-sample-plugin/compare/0.4.0...0.5.0) (2026-04-24)


### ⚠ BREAKING CHANGES

* Anyone running this locally must rename their .obsidian/plugins/obsidian-vite-sample-plugin/ folder to .obsidian/plugins/vite-sample-plugin/ before reloading the plugin.
...
* **release:** cut 0.5.0 with renamed plugin id ([0a402c6](https://github.com/tbhb/obsidian-vite-sample-plugin/commit/0a402c6075092933b1c7a76a34e182ff6a830f7d))
* rename plugin id to vite-sample-plugin ([#21](https://github.com/tbhb/obsidian-vite-sample-plugin/issues/21)) ([bfd68f0](https://github.com/tbhb/obsidian-vite-sample-plugin/commit/bfd68f09411ab5879a1b8eba0edc2656bb90a16e))
